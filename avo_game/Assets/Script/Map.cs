...
public class Map : MonoBehaviour {
    ...
    /*// 最短経路
    public int[] StartRoot(int x, int y, int movecost)
    {
        int[] root = new int[movecost];
        SearchRoot(x, y, movecost);
    }
    private void SearchRoot(int x, int y, int movecost)
    {
        Tip[] temp = new Tip[5];
